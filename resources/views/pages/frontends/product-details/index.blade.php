                ...
                <div class="product_d_right">
                    <form action="#">
                        ...
                        <div class="product_brand">
                            ...
                            <span><a href="#">{{$ProductData->name}} </a></span><span><a href="{{URL::to('product_child_category/'.$ProductData->slug)}}">| More Mobiles from {{$ProductData->name}}</a></span>
                        </div>
                        ...
                        <div class="variants_selects">
                            <div class="variants_size">    
                                @foreach($varient as $val)
                                    <h2>{{$val->variant_name}} :</h2>
                                    
                                    @php 
                                    $varientItem = App\Models\Variantitem::where('product_id',$ProductData->id)->where('variant_id',$val->id)->select('id','variant_id', 'item')->get();
                                    @endphp
                                    @foreach($varientItem as $itemval)

                                    @if($itemval->variant_id===$val->id) 
                                    <div class="panel-default">
                                        <input id="payment_defult{{$itemval->id}}" name="check_method" type="radio">
                                        <label for="payment_defult{{$itemval->id}}"> {{$itemval->item}}</label>
                                    </div>
                                    @else
                                    <div class="panel">
                                        <input id="payment{{$itemval->id}}" name="check_method2" type="radio">
                                        <label for="payment{{$itemval->id}}"> {{$itemval->item}}</label>
                                    </div>
                                    @endif
                        ...
                        <div class="product_variant">  
                            ...
                            <button class="button"><a href="#" class="addToCart" data-id="{{$ProductData->id}}">add to cart</a></button>
                        </div> 

                        <div class="product_d_action">
                            <ul>
                                <li><a href="#" class="addToWishlist" data-id="{{$ProductData->id}}">+ Add to Wishlist</a></li>
                                <li><a href="#" title="Add to wishlist">+ Compare</a></li>
                            </ul>
                        </div>
                        
                        <div class="product_meta">
                            <span>Category: <a href="">{{$ProductData->c_name}}</a></span>
                        </div>
                    </form>
