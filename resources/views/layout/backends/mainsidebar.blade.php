    ...
    <ul class="sidebar-menu">
      ...
      <li class="nav-item dropdown">
        ...
        <ul class="dropdown-menu">
          ...
          <li class=""><a class="nav-link" href="{{url('/stock-status')}}">Stock Status</a></li>
      ...
      <li class="nav-item dropdown ">
        ...
        <ul class="dropdown-menu">
          <li class=""><a class="nav-link" href="{{route('all-order')}}">All Orders</a></li>
      ...
      <li class="nav-item dropdown">
        ...
        <ul class="dropdown-menu">
          <li class=""><a class="nav-link" href="{{route('user-list')}}">User List</a></li>
      ...
      <li class="nav-item dropdown ">
        ...
        <ul class="dropdown-menu">
          <li class=""><a class="nav-link" href="{{url('/blog-category')}}">Categories</a></li>
          <li class=""><a class="nav-link" href="{{url('/blog-list')}}">Blogs</a></li>
          <li class=""><a class="nav-link" href="{{url('/comment')}}">Comments</a></li>
        </ul>
      </li>
      ...
      <li class=""><a class="nav-link" href="{{url('admin-list')}}"><i class="fas fa-user"></i> <span>Admin list</span></a></li>
    </ul>       
  </aside>
</div>
