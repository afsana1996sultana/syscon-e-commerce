            ...
            <div class="col-12">
                <div class="breadcrumb_content">
                    <ul>
                        ...
                        <li>Product Child Category</li>
                        <li>{{$ChildcategoryId->child_category}}</li>
                    </ul>
                </div>
            </div>
        </div>
                        ...
                        <article class="single_product">
                            <figure>
                                ...
                                <div class="product_content grid_content">
                                    ...
                                    <h3 class="product_name grid_name"><a href="{{URL::to('product_details/'.$Val->slug)}}">{{$Val->p_name}}</a></h3>
                                </div>
                                <div class="product_content list_content">
                                    <div class="left_caption">
                                        ...
                                        <h3 class="product_name"><a href="{{URL::to('product_details/'.$Val->slug)}}">{{$Val->p_name}}</a></h3>
                                        <div class="product_ratings">
                                            <ul>
                                                <li><a href="#"><i class="ion-android-star-outline"></i></a></li>
                                                <li><a href="#"><i class="ion-android-star-outline"></i></a></li>
                                    ...
                                    <div class="right_caption">
                                        ...
                                        <div class="action_links">
                                            <ul>
                                                <li class="wishlist"><a href="#" class="addToWishlist" data-id="{{$Val->id}}"
                                                    title="Add to Wishlist"><i class="fa fa-heart-o"
                                                    aria-hidden="true"></i> Add to Wishlist</a></li>
                                                <li class="compare"><a href="#" title="compare"><span
                                                    class="ion-levels"></span> Compare</a></li>
                                                <li class="quick_button" ><a class="quick_view" id="{{$Val->slug}}"  
                                                    title="quick view"> <span class="ion-ios-search-strong"></span> Quick View</a></li>
                                            </ul>
                                        </div>
                                    </div>
                                </div>
