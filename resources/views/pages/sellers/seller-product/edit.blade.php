...
<div class="main-content">
	<section class="section">
        ...
        <div class="section-body">
            <a href="{{url('seller/product')}}" class="btn btn-primary"><i class="fas fa-list"></i> Products</a>
            <div class="row mt-4">
                <div class="col-12">
                  <div class="card">
                    <div class="card-body">
                        <form action="{{url('seller/product/'.$productseller->id)}}" method="POST" enctype="multipart/form-data">
                            @csrf
                            @method('PUT')                        
                            <div class="row">
                                <div class="form-group col-12">
                                    ...
                                    <div>
                                        <img id="preview-img" src="{{asset('img/'.$productseller->img)}}" alt="" sizes="" srcset="" height="120px" width="160px"> 
                                    </div>
                                </div>
                                ...
                                <div class="form-group col-12">
                                    ...
                                    <div>
                                    <img src="{{asset('img/'.$productseller->banner_img)}}" alt="" sizes="" srcset="" height="120px" width="160px"> 
                                    </div>
                                </div>
                                ...
                                <div class="form-group col-12">
                                    ...
                                    <input type="text" id="txtShortName" class="form-control"  name="txtShortName" value="{{$productseller->short_name}}">
                                </div>

                                <div class="form-group col-12">
                                    <label>Name <span class="text-danger">*</span></label>
                                    <input type="text" id="txtName" class="form-control"  name="txtName" value="{{$productseller->p_name}}">
                                </div>

                                <div class="form-group col-12">
                                    <label>Seller Id <span class="text-danger">*</span></label>
                                    <input type="text" id="txtSellerId" class="form-control"  name="txtSelletxtSellerIdrName" value="{{$productseller->seller_id}}">
                                </div>

                                <div class="form-group col-12">
                                    <label>Slug <span class="text-danger">*</span></label>
                                    <input type="text" id="txtSlug" class="form-control"  name="txtSlug" value="{{$productseller->slug}}">
                                </div>

                                <div class="form-group col-12">
                                    <label>Model No: <span class="text-danger">*</span></label>
                                    <input type="text" id="txtModelNo" class="form-control"  name="txtModelNo" value="{{$productseller->model_no}}">
                                </div>
                                ...
                                <div class="form-group col-12">
                                    ...
                                    <select id="txtCategory" class="form-control" name="txtCategory">
                                        ...
                                        <option value="{{ $category->id }}" {{ ( $category->id == $productseller->category) ? 'selected' : '' }}>
                                            {{ $category->c_name }}
                                        </option>
                                        @endforeach
                                    </select>
                                ...
                                <div class="form-group col-12">
                                    ...
                                    <select id="txtSubcategory" class="form-control" name="txtSubcategory">
                                        ...
                                        <option value="{{ $subcategory->id }}" {{ ( $subcategory->id == $productseller->sub_category) ? 'selected' : '' }}>
                                ...
                                <div class="form-group col-12">
                                    ...
                                    <select id="txtChildcategory" class="form-control" name="txtChildcategory">
                                        ...
                                        <option value="{{ $childcategory->id }}" {{ ( $childcategory->id == $productseller->child_category) ? 'selected' : '' }}>
                                ...
                                <div class="form-group col-12">
                                    ...
                                    <select id="txtBrand" class="form-control" name="txtBrand">
                                        ...
                                        <option value="{{ $brand->id }}" {{ ( $brand->id == $productseller->brand) ? 'selected' : '' }}>
                                            {{ $brand->name }}
                                        </option>
                                        @endforeach
                                    </select>
                                ...
                                <div class="form-group col-12">
                                    <label>SKU </label>
                                    <input type="text" class="form-control" name="txtSku" value="{{$productseller->sku}}">
                                </div>

                                <div class="form-group col-12">
                                    <label>Purchase Scaner</label>
                                    <select name="txtPurchaseScane" id="txtPurchaseScane" class="form-control">
                                        <option value="1" {{$productseller->purchase_scane==1 ? "selected" : ""}}>Barcode</option>
                                        <option value="2" {{$productseller->purchase_scane==2 ?  "selected" : ""}}>Serial No</option>
                                        <option value="3" {{$productseller->purchase_scane==3 ?  "selected" : ""}} >IMI No</option>
                                    </select>
                                </div>
                                ...
                                <div class="form-group col-12">
                                    ...
                                    <select id="txtUnit" class="form-control" name="txtUnit">
                                        ...
                                        <option value="{{ $unit->id }}" {{ ( $unit->id == $productseller->unit) ? 'selected' : '' }}>
                                            {{ $unit->unit_name }}
                                        </option>
                                        @endforeach
                                    </select>
                                ...
                                <div class="form-group col-12">
                                    ...
                                    <input type="text" class="form-control" name="txtPrice" value="{{$productseller->price}}">
                                </div>

                                <div class="form-group col-12">
                                    <label>Offer Price</label>
                                    <input type="text" class="form-control" name="txtOfferPrice" value="{{$productseller->offer_price}}">
                                </div>

                                <div class="form-group col-12">
                                    <label>Stock Quantity <span class="text-danger">*</span></label>
                                    <input type="number" class="form-control" name="txtStockQuantity" value="{{$productseller->stock_quantity}}">
                                </div>

                                <div class="form-group col-12">
                                    <label>Video Link</label>
                                    <input type="text" class="form-control" name="txtVideoLink" value="{{$productseller->video_link}}">
                                </div>

                                <div class="form-group col-12">
                                    <label>Short Description <span class="text-danger">*</span></label>
                                    <textarea name="txtShortDescription" id="" cols="30" rows="10" class="form-control text-area-5">{{$productseller->short_description}}</textarea>
                                </div>

                                <div class="form-group col-12">
                                    <label>Long Description <span class="text-danger">*</span></label>
                                    <textarea name="txtLongDescription" id="txtLongDescription" class="summernote">{{$productseller->long_description}}</textarea>
                                </div>

                                <div class="form-group col-12">
                                    <label>Tags</label>
                                    <input type="text" class="form-control" name="txtTag" value="{{$productseller->tag}}">
                                </div>
                                ...
                                <div class="form-group col-12">
                                    ...
                                    <select id="txtTax" class="form-control" name="txtTax">
                                        <option selected><-----Choose Category----></option>
                                        @foreach ($tax as $val)
                                        <option value="{{ $val->id }}" {{ ( $val->id == $productseller->tax) ? 'selected' : '' }}>
                                            {{ $val->title }}
                                        </option>
                                        @endforeach
                                    </select>
                                ...
                                <div class="form-group col-12">
                                    ...
                                    <select name="txtReturnPolicy" class="form-control" id="txtReturnPolicy" >
                                        <option value="0" {{$productseller->return_policy==0 ? "selected" : ""}}>No</option>
                                        <option value="1" {{$productseller->return_policy==1 ? "selected" : ""}}>Yes</option>
                                    </select>
                                </div>
                                ...
                                <div class="form-group col-12">
                                    ...
                                    <select name="txtWarranty" id="txtWarranty" class="form-control">
                                        <option value="1" {{$productseller->warranty==1 ? "selected" : ""}}>Yes</option>
                                        <option value="0" {{$productseller->warranty==0 ? "selected" : ""}}>No</option>
                                    </select>
                                </div>
                                ...
                                <div class="form-group col-12">
                                    ...
                                    <select id="txtStatus" class="form-control" name="txtStatus" required>
                                        ...
                                        <option value="{{ $status->id }}" {{ ( $status->id == $productseller->status) ? 'selected' : '' }}>
                                            {{ $status->s_name }}
                                        </option>
                                        @endforeach
                                    </select>  
                                ...
                                <div class="form-group col-12">
                                    ...
                                    <input type="text" class="form-control" name="txtSeoTitle" id="txtSeoTitle" value="{{$productseller->seo_title}}">
                                </div>

                                <div class="form-group col-12">
                                    <label>SEO Description</label>
                                    <textarea name="txtSeoDescription" id="txtSeoDescription" cols="30" rows="10" class="form-control text-area-5">{{$productseller->seo_description}}</textarea>
                                </div>
