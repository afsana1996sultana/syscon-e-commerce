  ...
  <aside id="sidebar-wrapper">
    ...
    <ul class="sidebar-menu">
      ...
      <li class="nav-item dropdown">
        ...
        <ul class="dropdown-menu">
          <li><a class="nav-link" href="{{url('/seller/product/create')}}">Product Create</a></li>
      ...
      <li class=""><a class="nav-link" href="{{url('/customer-dashboard/my-account')}}"><i class="fas fa-user"></i> <span>Visit User Dashboard</span></a></li>
    </ul>       
  </aside>
</div>
