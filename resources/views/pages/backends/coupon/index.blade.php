                            ...
                            <table class="table table-striped" id="table-1">
								<thead>
									<tr>
										...
										<th class="sorting">Coupon For</th>
                ...
                <div class="container-fluid">
                    <form action="{{route('coupon.store')}}" method="POST">
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-12">
                                <label>Coupon Number <span class="text-danger">*</span></label>
                                <input type="number" id="txtCouponNumber" class="form-control"  name="txtCouponNumber">
                            </div>

                            <div class="form-group col-12">
                                <label>Start Time <span class="text-danger">*</span></label>
                                <input type="text" id="date" class="form-control datetimepicker_mask"  name="txtCouponStartTime" autocomplete="off">
                            </div>

                            <div class="form-group col-12">
                                <label>End Time <span class="text-danger">*</span></label>
                                <input type="text" id="datee" class="form-control datetimepicker_mask"  name="txtCouponEndTime" autocomplete="off">
                            </div>
                            ...
                            <div class="form-group col-12">
                                ...
                                <select name="txtCouponFor" id="txtCouponFor" class="form-control">
                ...
                <div class="container-fluid">
                    <form action="{{url('coupon-update')}}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-12">
                                <label>Start Time <span class="text-danger">*</span></label>
                                <input type="text" id="eCouponStartTime" class="form-control datetimepicker_mask"  name="txtCouponStartTime" autocomplete="off">
                            </div>

                            <div class="form-group col-12">
                                <label>End Time <span class="text-danger">*</span></label>
                                <input type="text" id="eCouponEndTime" class="form-control datetimepicker_mask"  name="txtCouponEndTime" autocomplete="off">
                            </div>
                            ...
                            <div class="form-group col-12">
                                <label>Coupon For</label>
                                <select name="txtCouponFor" id="eCouponFor" class="form-control">
                                    <option value=""><----Select----></option>
                                    <option value="1">Public</option>
                                    <option value="2">Private</option>
                                </select>
		...
		$(document).on('click','#editcoupon',function(){
			...
			$.ajax({
				...
				success:function(response){
                    ...
                    $('#eCouponStartTime').val(response.coupon.start_time);
                    $('#eCouponEndTime').val(response.coupon.end_time);
                    $('#eCouponDiscount').val(response.coupon.coupon_discount);
                    $('#eCouponDiscountType').val(response.coupon.discount_type);
                    $('#eCouponFor').val(response.coupon.coupon_for);
